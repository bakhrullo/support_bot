...
def pdf_create(number, name):
    ...
    9.1 Договор вступает в силу со дня подписания обеими сторонами и действует до 31 декабря 2023 года.
    ...
    г.Ташкент, Чиланзарский район,                                Адрес:______________________________
    ул.Арнасай, 1А                                                              ____________________________________
    Р/с 20208000904736147001                                         Р/сч ________________________________
    МФО 00444                                                                    МФО _______________________________
    в ОПЕРУ АИКБ «Ипак Йули»                                         в ___________________________________
    ИНН 300974584   ОКЭД 46360                                     ИНН __________________ ОКЭД _______
    Тел: (871) 253-11-87                                                     Тел: (_____) _________________________
