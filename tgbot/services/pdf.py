...
def pdf_create(number, name, types):
    ...
    {types}                                Адрес:______________________________
                                         ...
                                         ИНН __________________ ОКЭД _______
...
pdf_create(123, "aг.Ташкент, Чиланзарский район,ул.Арнасай, 1А Р/с 20208000904736147001 МФО 00444 в ОПЕРУ АИКБ «Ипак Йули» ИНН 300974584   ОКЭД 46360 Тел: (871) 253-11-87     wdaw", "")